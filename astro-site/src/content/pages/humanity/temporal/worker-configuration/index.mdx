...
<summary style="cursor: pointer; margin-bottom: 1rem;">Click to expand</summary>
...
<figure style="margin: 2rem 0; text-align: center;">
    <img
        src="/humanity/temporal/worker-configuration/stats-by-prioQ.png"
        alt="stats by prioQ"
        style="max-width: 50%;"
    />
...
<figure style="margin: 2rem 0;">
    <img
        src="/humanity/temporal/worker-configuration/failures-workflowtasklatency.png"
...
<figure style="margin: 2rem 0;">
    <img
        src="/humanity/temporal/worker-configuration/failures-slots.png"
...
<figure style="margin: 2rem 0;">
    <img
        src="/humanity/temporal/worker-configuration/50+pollers-cpu.png"
...
<figure style="margin: 2rem 0;">
    <img
        src="/humanity/temporal/worker-configuration/tuner-2vcpu.png"
...
<figure style="margin: 2rem 0;">
    <img
        src="/humanity/temporal/worker-configuration/2vCPU-CPU.png"
...
I have explored more in detail the tuner, running on 2vCPU instances, and poller configuration, which you can read about in the [deep-dive](/humanity/temporal/worker-configuration/deep-dive) article.
...
<figure style="margin: 2rem 0;">
    <img
        src="/humanity/temporal/worker-configuration/saturated-wftask-latency.png"
        alt="workflow tasks latency"
        style="max-width: 100%;"
    />
    <img
        src="/humanity/temporal/worker-configuration/saturated-wftasks-failures.png"
...
If you are interested in understanding the configuration and the details of the many experiments I have run, you can read the [deep-dive](/humanity/temporal/worker-configuration/deep-dive) article.
